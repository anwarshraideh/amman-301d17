...
let nsumAndProduct = (a, b) => {
  let sum = a + b;
  let product = a * b;
  return [sum, product];
};
console.log(nsumAndProduct(3, 9));
...
const nmessage = (name) => `Hello, ${name}!`;
console.log(nmessage('Allie'));
...
// because this is not bound to anything, and will inherit the value of this from its parent scope.
